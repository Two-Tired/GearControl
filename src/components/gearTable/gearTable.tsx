...
let testTable = createTestTable([10/9, 20/9, 30/9, 40/9, 50/9, 60/9, 70/9, 80/9, 90/9, 100/9]);
                ...
                {testTable.map((row, index) => {
                    ...
                    return (
                        <DataTable.Row key={index}>
                            <DataTable.Cell key={index}>{(row.speed * 3.6).toFixed(2)}</DataTable.Cell>
                            <DataTable.Cell key={index + 1}>{row.transmissionNeeded.toFixed(2)}</DataTable.Cell>
                            <DataTable.Cell key={index + 2}>{row.transmissionBest.toFixed(2)}</DataTable.Cell>
